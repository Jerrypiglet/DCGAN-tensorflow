...
class VariationalAutoencoder(object):
	...
	def _generator(self, input_sample, trainable=True):
		with tf.variable_scope("generator") as scope:
			...
			hidden_tensor_inv = ly.fully_connected(hidden_tensor_inv, self.flatten_length, activation_fn=self.transfer_fct_conv, normalizer_fn=ly.batch_norm, trainable=trainable, scope='g_fc3')
